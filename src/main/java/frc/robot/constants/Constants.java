...
public final class Constants {
	...
	public static final double SPEED_MULT = 1; // TODO
	...
	public static final double ANGULAR_SPEED = SWERVE_MAXSPEED*SPEED_MULT / Math.hypot(ROBOT_LENGTH, ROBOT_WIDTH)/2;

	public static final double RING_X_THRESHOLD = .20;
